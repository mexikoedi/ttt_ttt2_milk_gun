...
if SERVER then
    ...
    function ENT:PhysicsCollide( data , phys )
        ...
        if self.Collided <= CollisionsBeforeRemove then
            ...
            if !IsValid( self ) || !IsValid( Ent ) || !Ent:IsPlayer( ) then return end

            if !self.AlreadyHit[ Ent:GetName( ) ] && self:GetVelocity( ):LengthSqr( ) > MinSpeed * MinSpeed then
